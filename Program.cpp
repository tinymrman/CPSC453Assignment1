...
void KeyCallback(GLFWwindow* window, int key, int scancode, int action, int mods) {
	...
	if (key == GLFW_KEY_1 && action == GLFW_PRESS) {
		program->getScene()->changeToNestedSquareScene();
	}
	if (key == GLFW_KEY_2 && action == GLFW_PRESS) {
        program->getScene()->changeToSpiralScene();
	}
    if (key == GLFW_KEY_3 && action == GLFW_PRESS) {
        program->getScene()->changeToSierpinskiTriangleScene();
    }
    if (key == GLFW_KEY_4 && action == GLFW_PRESS) {
        program->getScene()->changeToRandomSierpinskiScene();
    }
    if (key == GLFW_KEY_5 && action == GLFW_PRESS) {
        program->getScene()->changeToBarnsleyFernScene();
    }
    if (key == GLFW_KEY_6 && action == GLFW_PRESS) {
        program->getScene()->changeToHilbertCurveScene();
    }
